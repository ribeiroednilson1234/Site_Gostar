...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Conjunto.sql"/>
<!Doctype html>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Conjunto.inserirRegistro ("Conjunto"));
	    out.println("<capition><h3>Tabela 'Conjunto' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar o Conjunto !</caption></h4>");
