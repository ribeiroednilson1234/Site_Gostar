...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Dispesas_diversas.sql"/>
<!Doctype html>
...
<title>Dispesas_diversas.html</title>
</head>
<body>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Dispesas_diversas.inserirRegistro ("Dispesas_diversas"));
	    out.println("<capition><h3>Tabela 'Dispesas_diversas' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar para dispesas diversas !</caption></h4>");
