...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Cadeira.sql"/>
<!Doctype html>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Cadeira.inserirRegistro ("Cadeira"));
	    out.println("<capition><h3>Tabela 'Cadeira' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar o Cadeira !</caption></h4>");
