...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Modelo.sql"/>
<!Doctype html>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Modelo.inserirRegistro ("Modelo"));
	    out.println("<capition><h3>Tabela 'Modelo' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar o Modelo !</caption></h4>");
