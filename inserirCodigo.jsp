...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Codigo.sql"/>
<!Doctype html>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Codigo.inserirRegistro ("Codigo"));
	    out.println("<capition><h3>Tabela 'Codigo' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar o Codigo !</caption></h4>");
