...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Mesa.sql"/>
<!Doctype html>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Mesa.inserirRegistro ("Mesa"));
	    out.println("<capition><h3>Tabela 'Mesa' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar o Mesa !</caption></h4>");
