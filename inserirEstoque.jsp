...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Estoque.sql"/>
<!Doctype html>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Estoque.inserirRegistro ("Estoque"));
	    out.println("<capition><h3>Tabela 'Estoque' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar para o estoque !</caption></h4>");
