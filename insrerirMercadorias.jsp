...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Mercadorias.sql"/>
<!Doctype html>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Mercadorias.inserirRegistro ("Mercadorias"));
	    out.println("<capition><h3>Tabela 'Mercadorias' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar o Mercadorias !</caption></h4>");
