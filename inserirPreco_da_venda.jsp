...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Preco_da_venda.sql"/>
<!Doctype html>
...
<title>Preco_da_venda.html</title>
</head>
<body>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Preco_da_venda.inserirRegistro ("Preco_da_venda"));
	    out.println("<capition><h3>Tabela 'Preco_da_venda' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar o Preço da venda !</caption></h4>");
