...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Colaborador.sql"/>
<!Doctype html>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Colaborador.inserirRegistro ("Colaborador"));
	    out.println("<capition><h3>Tabela 'Colaborador' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar o colaborador !</caption></h4>");
