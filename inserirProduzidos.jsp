...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Produzidos.sql"/>
<!Doctype html>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Produzidos.inserirRegistro ("Produzidos"));
	    out.println("<capition><h3>Tabela 'Produzidos' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar para produzidos !</caption></h4>");
