...
<jsp: use* id="Like_DB.sql" scope="page" class="banco_dados.Balanco.sql"/>
<!Doctype html>
...
if(conexao.abrirConexao('Like_DB.sql')) {
	...
	if (Balanco.inserirRegistro ("Balanco"));
	    out.println("<capition><h3>Tabela 'Balanco' cadastro realizado.</h3></caption>");
	else 
	   out.println("<caption><h4>Erro ao tentar cadastrar para balanço !</caption></h4>");
